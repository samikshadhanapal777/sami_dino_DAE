...
async function loadSchedule() {
    try {
        ...
        // Fallback demo data if PHP not running yet
        loadScheduleDemo();
    }
}
...
function renderWeekCalendar() {
    ...
    // Sample week events [col 0=Mon .. 6=Sun]
    const events = [
        { col: 0, label: "Biology Study", time: "11:00 AM", cls: "ev-green" },
        { col: 1, label: "Math Practice", time: "1:00 AM",  cls: "ev-orange" },
        { col: 2, label: "History Notes", time: "1:00 AM",  cls: "ev-blue" },
        { col: 3, label: "English Essay", time: "1:00 AM",  cls: "ev-red" },
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Set today's date in welcome
    const now = new Date();
    // (Optional: fetch real username from session)
});
